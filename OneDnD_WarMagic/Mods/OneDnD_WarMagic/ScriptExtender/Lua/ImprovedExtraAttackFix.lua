...
if Ext.Mod.IsModLoaded("755a8a72-407f-4f0d-9a33-274ac0f0b53d") and Mods.BG3MCM.MCMAPI:GetSettingValue("debugToggle", "7429b169-5e11-4d31-9db3-b1285df2d191") then
	debugEnabled = Mods.BG3MCM.MCMAPI:GetSettingValue("debugToggle", "7429b169-5e11-4d31-9db3-b1285df2d191") 
end
    ...
    if state.attacksLeft > 0 then
        ...
        if spellStats.Level == 0 and Osi.SpellHasSpellFlag(spell, "IsSpell") == 1 then
            ...
            if splitUseCost == "BonusActionPoint:1" or spellUseCost == "BonusActionPoint:1" then
                ...
                if state.cantripUsed == false then
...
Ext.Osiris.RegisterListener("UsingSpell", 5, "after", function(attacker, spell, _, _, _)
